...
public class CustomerServiceControllerIntegrationTest {
  ...
  public void verifyCustomerServiceForSuccessfulInsertion() throws Exception {
    RequestBuilder requestBuilder =
        MockMvcRequestBuilders.post("/api/v1/customer/add")
            .content(
                "\"firstName\": \"Nikita\",\r\n"
                    + " \"lastName\":\"Tambe\",\r\n"
    ...
    mockMvc
        ...
        .andExpect(
            MockMvcResultMatchers.jsonPath("$.message").value("Customer added successfully!!"))
        .andReturn();
  }
    ...
    mockMvc
        ...
        .andExpect(
            MockMvcResultMatchers.jsonPath("$.message")
                .value("Email is already exist! Please enter valid emailID"))
        .andReturn();
  }
}
