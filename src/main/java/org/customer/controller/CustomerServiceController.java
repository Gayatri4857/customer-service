...
public class CustomerServiceController {
  ...
  public AddUpdateCustomerResponse addCustomerDetails(
      @Valid @RequestBody AddUpdateCustomerRequest request) {
    return CustomerServiceImpl.addCustomerDetails(request);
  }

  @PostMapping(
      path = "/api/v1/customer/update/{customerId}",
      consumes = {"application/json", "application/xml"},
      produces = {"application/json", "application/xml"})
  public AddUpdateCustomerResponse addCustomerDetails(
      @Valid @PathVariable String customerId, @RequestBody AddUpdateCustomerRequest request) {
    return CustomerServiceImpl.updateCustomerDetails(customerId, request);
  }

  @GetMapping(
      path = "/api/v1/customer/search/{mobile_number}",
      consumes = {"application/json", "application/xml"},
      produces = {"application/json", "application/xml"})
